package com.hollingsworth.schematic.siteexport.libs.micromark.html;
...
public final class NumericCharacterReference {
    ...
    /**
     * Turn the number (in string form as either hexa- or plain decimal) coming from a numeric character reference into
     * a character.
     *
