...
//        registerNormalCube(BlockRegistry.MIRROR_WEAVE, LibBlockNames.MIRROR_WEAVE);
    ...
    public void signBlock(Block sign, String reg) {
        ModelFile signModel = models().withExistingParent(reg, new ResourceLocation("block/air")).texture("particle", new ResourceLocation(SchematicMod.MODID, "block/" + reg));
    ...
    public ResourceLocation getBlockLoc(String registryName) {
        return new ResourceLocation(SchematicMod.MODID, "blocks" + "/" + registryName);
    }
